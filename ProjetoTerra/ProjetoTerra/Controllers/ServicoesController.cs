...
namespace ProjetoTerra.Controllers
{
    public class ServicoesController : Controller
    {
        ...
        public ServicoesController(GerenterraContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id_servico,nome,preco,tipo,descricao")] Servico servico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_servico,nome,preco,tipo,descricao")] Servico servico)
        {
